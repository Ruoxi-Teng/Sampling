...
def plot_treatment_paradigms(results, total_stats, num_clinics):
    ...
    for sample in results['Sample'].unique():
        ...
        plt.scatter(sample_data['FailureToTreatPercentage'], sample_data['UnnecessaryUsePercentage'], color='grey',
                    alpha=0.1, s=10)
    ...
    plt.scatter(mean_results['FailureToTreatPercentage'], mean_results['UnnecessaryUsePercentage'], color='red',
                    alpha=0.1, s=10,
