...
for num_clinics in [1, 5, 10]:
    ...
    results_df.to_csv(f"Data/random_dots_summary_{num_clinics}.csv", index=False)
    ...
    mean_results.to_csv(f"Data/random_dots_summary_mean_{num_clinics}.csv", index=False)
